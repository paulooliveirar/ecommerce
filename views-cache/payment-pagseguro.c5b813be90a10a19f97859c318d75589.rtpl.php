<?php if(!class_exists('Rain\Tpl')){exit;}?><!-- Declaração do formulário -->  
        ...
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="paulooliveirar@hotmail.com">  
        ...
        <input name="extraAmount" type="hidden" value="<?php echo htmlspecialchars( $cart["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
