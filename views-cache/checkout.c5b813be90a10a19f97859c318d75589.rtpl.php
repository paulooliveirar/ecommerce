											...
											<table class="shop_table">
												...
												<tfoot>
													<tr class="cart-subtotal">
														<th>Subtotal</th>
														<td><span class="amount">R$<?php echo format_price($cart["vlsubtotal"]); ?></span>
														</td>
													</tr>
													<tr class="shipping">
														<th>Frete</th>
														<td>
															R$<?php echo format_price($cart["vlfreight"]); ?>
													...
													<tr class="order-total">
														...
														<td><strong><span class="amount">R$<?php echo format_price($cart["vltotal"]); ?></span></strong> </td>
													</tr>
												</tfoot>
											</table>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
