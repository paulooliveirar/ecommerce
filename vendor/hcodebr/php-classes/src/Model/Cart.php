...
class Cart extends Model {
	...
	public function getProductsTotals(){
		...
		$results = $sql->select("
			SELECT SUM(vlprice) AS vlprice, SUM(vlweight) AS vlweight, SUM(vlheight) AS vlheight, 
			SUM(vllength) AS vllength, SUM(vlwidth) AS vlwidth, COUNT(*) AS nrqtd 
			FROM tb_products a 
	...
	public function setFreight($nrzipcode){
		...
		public function getCalculateTotal(){
			...
			if($total['nrqtd'] == 0){
				$this->setvlfreight(Cart::formatValueToDecimal(0));
				$this->setnrdays(0);
			}
