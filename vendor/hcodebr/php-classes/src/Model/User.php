...
class User extends Model {
	...
	const SUCESS = "UserErrorRegister";
	...
	public static function getForgot($email, $inadmin = true){
		...
		if(count($results) === 0)
		{
			...
			if(count($results2) === 0){
				...
				if($inadmin === true){
					$link = "http://www.minhalojavirtual.com.br/admin/forgot/reset?code=$result";
				}
				else{
					$link = "http://www.minhalojavirtual.com.br/forgot/reset?code=$result";
				}
